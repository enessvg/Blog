        ...
        <?php $__currentLoopData = $post; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $posts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="custom-center">
                <div
                    ...
                    <a href="post/detail/<?php echo e($posts['slug']); ?>" class="custom-center">
                        <img class="rounded-t-lg fixed-image" src="http://localhost:8181/storage/<?php echo e($posts['image']); ?>"
                            alt="" />
                    </a>
                    <div class="p-5">
                        <a href="post/detail/<?php echo e($posts['slug']); ?>">
                            <h5
                                class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white fixed-title">
                                <?php echo e($posts['title']); ?></h5>
                        </a>
                        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 fixed-content">
                            <?php echo e(Str::limit(html_entity_decode(strip_tags($posts['content'])), 100)); ?></p>
                        <a href="post/detail/<?php echo e($posts['slug']); ?>"
...
<?php endif; ?>
<?php /**PATH C:\Users\KLE\Desktop\Blog\blog-frontend\resources\views/post/popular-post.blade.php ENDPATH**/ ?>