                    ...
                    <div
                        ...
                        <a href="post/detail/<?php echo e($posts['slug']); ?>" class="custom-center">
                            <img class="rounded-t-lg fixed-image"
                                src="http://localhost:8181/storage/<?php echo e($posts['image']); ?>" alt="" />
                        </a>
                        <div class="p-5">
...
<?php endif; ?>
<?php /**PATH C:\Users\KLE\Desktop\Blog\blog-frontend\resources\views/post/all-post.blade.php ENDPATH**/ ?>